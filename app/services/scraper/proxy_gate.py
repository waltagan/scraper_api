"""
Proxy gate — gerencia conexão ao proxy 711Proxy.

Modo IP direto (165.154.135.29): sem overhead de gateway DNS.
Semáforo alto (2000) como safety net, não como bottleneck.
Stress test validou 99.7% success com 2000 concurrent no IP direto.
"""
