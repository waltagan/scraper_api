...
async def v2_root():
    ...
    return {
        ...
        "endpoints": {
            ...
            "scrape_main_page": "POST /v2/scrape/main-page",
            "scrape_main_page_unified": "POST /v2/scrape/main-page/unified",
            "scrape_main_page_batch": "POST /v2/scrape/main-page/batch",
            "scrape_main_page_unified_batch": "POST /v2/scrape/main-page/unified/batch",
            "scrape_extract_subpage_links": "POST /v2/scrape/main-page/subpage-links",
            "scrape_extract_subpage_links_batch": "POST /v2/scrape/main-page/subpage-links/batch",
            "scrape_process_mainpage_text": "POST /v2/scrape/main-page/process-text",
            "scrape_process_mainpage_text_batch": "POST /v2/scrape/main-page/process-text/batch",
